...
public class Main {
    public static void main(String[] args) {
        List<Book> books = Arrays.asList(new Book("The Alchemist", "Fantasy", 1988, 15.42),
        ...
        books.stream().filter(el -> el.getGenre().equals("Adventure"))
                .map(el -> new Book(el.getTitle(), el.getGenre(), el.getYear(),
                        el.getPrice() * 0.5))
