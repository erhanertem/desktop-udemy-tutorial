...
function App() {
	...
	// // > OBJECT MEMOIZATION W/MO DEPENDECY
	// // const archievedOptions = {
	// // 	show: false,
	// // 	title: 'Post archieve in addition to main posts',
	// // };
	// const archievedOptions = useMemo(() => {
	// 	return {
	// 		show: false,
	// 		title: 'Post archieve in addition to main posts',
	// 	};
	...
	return (
		<section>
			...
			{/* <Archive show={false} /> */}
			<Archive
				archievedOptions={archievedOptions}
...
const Archive = memo(function ({ archievedOptions, onAddPost, setIsFakeDark }) {
	...
	const [showArchive, setShowArchive] = useState(archievedOptions.show);

	return (
		<aside>
			<h2>{archievedOptions.title}</h2>
			{/* <h2>Post archive</h2> */}
