  ...
  return (
    <div className='list-container'>
      ...
      {isOpen && (
        <ul className='list'>
          {displayItems.map(
            render // Functionalized render content
          )}
        </ul>
      )}
...
// > #3. HOC RETURNS A NEW COMPONENT
const ProductListWithToggles = withToggles(ProductList);

// > #1.THE COMPONENT WE WANT TO USE FOR HOC
...
export default function App() {
  return (
    <div>
      ...
      {/* HOC PATTERN */}
      {/* PER-SE 3RD PARTY LIBRARY EXPOSED COMPONENT THAT WE WANT TO MODIFY */}
      <div className='col-2'>
        <ProductList
          title='Products HOC'
          items={products}
