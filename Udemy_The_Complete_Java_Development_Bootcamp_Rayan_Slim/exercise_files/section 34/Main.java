...
public class Main {
    public static void main(String[] args) {
        Movie movie1 = new Movie("Pulp Fiction", "Quentin Tarantino", "Crime", 1994, 8.9);
        Movie movie2 = new Movie("The Dark Knight", "Christopher Nolan", "Action", 2008, 9.0);
        Movie movie3 =
                new Movie("The Matrix", "Lana Wachowski, Lilly Wachowski", "Sci-Fi", 1999, 8.7);
        Movie movie4 = new Movie("Inception", "Christopher Nolan", "Sci-Fi", 2010, 8.8);
        ...
        List<Movie> sortedActor = movieStore.sortByActor();
        ...
        sortedActor.forEach(movie -> System.out.println(movie));
