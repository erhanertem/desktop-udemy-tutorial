    ...
    public void begin(Team home, Team away) {
        ...
        System.out.println(
                "\n - This matchup takes place at the " + this.arena + " arena on " + formattedDate + "." +
                        ...
                        + home.getPlayer("SMALL_FORWARD") + "; at power forward, "
                        + home.getPlayer("POWER_FORWARD")
                        + "; and at center, "
                        + home.getPlayer("HOME_CENTER") + ".\n" +
                        ...
                        + away.getPlayer("SMALL_FORWARD") + "; at power forward, "
                        + away.getPlayer("POWER_FORWARD") + "; and at center, "
