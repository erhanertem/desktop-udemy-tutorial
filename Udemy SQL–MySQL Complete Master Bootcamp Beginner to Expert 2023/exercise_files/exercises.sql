...
-- LESSON 85~86 COMBINING SQL WITH TABLEAU
/*
BUSINESS INTELIGENCE (BI) PROCESS: 
1. DATA MINING -SQL+STATISTICS KNOWLEDGE+PYHTON
2. REPORTING - ANALYSIS CONVEYED THRU TABLEAU
3. PERFORMANCE METRICS AND BENCHMARKING - TABLEAU ...COMPARISON TO OLD DATA SETS
 */